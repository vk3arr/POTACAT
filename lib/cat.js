...
class RigctldClient extends EventEmitter {
  ...
  tune(frequencyHz, mode, { split, filterWidth } = {}) {
    ...
    // Do NOT re-send mode after frequency for rigctld — unlike Yaesu serial where
    // band-recall overrides mode, rigctld/hamlib maintains mode correctly. Re-sending
    // mode after frequency causes CW pitch offset shift on radios like the FT-710.
