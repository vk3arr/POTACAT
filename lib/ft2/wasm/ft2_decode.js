...
async function ___ft2DecodeModule___(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('ft2_decode.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('ft2_decode.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(_ft2_exec_decode|invoke_.*|__asyncjs__.*)$/;
...
var _ft2_init_decode = Module['_ft2_init_decode'] = makeInvalidEarlyAccess('_ft2_init_decode');
var _ft2_exec_decode = Module['_ft2_exec_decode'] = makeInvalidEarlyAccess('_ft2_exec_decode');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ft2_init_decode'] != 'undefined', 'missing Wasm export: ft2_init_decode');
  assert(typeof wasmExports['ft2_exec_decode'] != 'undefined', 'missing Wasm export: ft2_exec_decode');
  ...
  _ft2_init_decode = Module['_ft2_init_decode'] = createExportWrapper('ft2_init_decode', 0);
  _ft2_exec_decode = Module['_ft2_exec_decode'] = createExportWrapper('ft2_exec_decode', 3);
...
export default ___ft2DecodeModule___;
