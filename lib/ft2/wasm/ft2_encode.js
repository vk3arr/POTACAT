...
async function ___ft2EncodeModule___(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('ft2_encode.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('ft2_encode.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(_ft2_exec_encode|invoke_.*|__asyncjs__.*)$/;
...
var _ft2_exec_encode = Module['_ft2_exec_encode'] = makeInvalidEarlyAccess('_ft2_exec_encode');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ft2_exec_encode'] != 'undefined', 'missing Wasm export: ft2_exec_encode');
  ...
  _ft2_exec_encode = Module['_ft2_exec_encode'] = createExportWrapper('ft2_exec_encode', 3);
...
export default ___ft2EncodeModule___;
